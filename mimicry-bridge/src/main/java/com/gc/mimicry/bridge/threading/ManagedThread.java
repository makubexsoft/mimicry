...
/**
 * Subclasses of this class provide a graceful termination strategy and are used
 * to clean up a simulated application asynchronously.
 * 
...
{
	/**
	 * Override of the original constructor {@link Thread#Thread()} which is
	 * invoked by the subclass.
	 */
	...
	/**
	 * Override of the original constructor
	 * {@link Thread#Thread(Runnable, String)} which is invoked by the subclass.
	 */
	...
	/**
	 * Override of the original constructor {@link Thread#Thread(Runnable)}
	 * which is invoked by the subclass.
	 * 
	 * @see Thread#Thread()
	 */
	...
	/**
	 * Override of the original constructor {@link Thread#Thread(String)} which
	 * is invoked by the subclass.
	 * 
	...
	/**
	 * Override of the original constructor
	 * {@link Thread#Thread(ThreadGroup, Runnable, String, long)} which is
	 * invoked by the subclass.
	 * 
	...
	/**
	 * Override of the original constructor
	 * {@link Thread#Thread(ThreadGroup, Runnable, String)} which is invoked by
	 * the subclass.
	 * 
	...
	/**
	 * Override of the original constructor
	 * {@link Thread#Thread(ThreadGroup, Runnable)} which is invoked by the
	 * subclass.
	 * 
	...
	/**
	 * Override of the original constructor
	 * {@link Thread#Thread(ThreadGroup, String)} which is invoked by the
	 * subclass.
	 * 
