...
/**
 * The simulator bridge provides access for the aspects woven into the
 * application code to the simulator that loaded the application. It should not
...
public final class SimulatorBridge
{
	...
	/**
	 * Gets invoked when the application wants to shutdown itself, e.g.
	 * {@link System#exit()} has been invoked, as well as by the
	 * {@link ApplicationBridge}.
	 */
