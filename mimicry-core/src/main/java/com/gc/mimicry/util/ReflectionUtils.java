...
public class ReflectionUtils
{
	...
	public static boolean areMatchingBoxTypes( Class<?> one, Class<?> two )
	{
		...
		if ( (Long.class.equals( one ) && long.class.equals( two ))
				|| (Long.class.equals( two ) && long.class.equals( one )) )
		{
			return true;
		}
		...
		if ( (Byte.class.equals( one ) && byte.class.equals( two ))
				|| (Byte.class.equals( two ) && byte.class.equals( one )) )
		{
			return true;
		}
