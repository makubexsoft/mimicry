...
/**
 * A {@link ResourceManager} allows attaching {@link Closeable}s that will be
 * closed too, when the manager is closed.
 * 
...
{
	/**
	 * Attaches a resource to this manager that is closed when the resource
	 * manager is closed.
	 * 
	 * @param resource
	 */
