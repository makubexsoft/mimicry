...
/**
 * This {@link MessageType#DATA} message contains an
 * {@link ApplicationDescriptor} and the binary data of the application bundle.
 * It's used to deploy an application to a remote node.
 * 
