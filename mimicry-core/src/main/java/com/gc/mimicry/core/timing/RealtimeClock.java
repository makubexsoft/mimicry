...
/**
 * This clock implementation models a realtime timeline in which the time
 * advances automatically by the given speed multiplier. The clock can be paused
 * and resumed.
 * 
...
public class RealtimeClock extends AbstractClock
{
	...
	/**
	 * Constructs a new clock with the given millis as current time. The clock
	 * is initially stopped and need to be started manually using
	 * {@link #start(double)}.
	 * 
	 * @param initialMillis
	 */
	...
	/**
	 * Stops advancing the clock. The clock can be resumed by invoking
	 * {@link #start(double)} again.
	 * 
	 * @return
	 */
	public double stop()
