...
public class ApplicationDescriptor implements Serializable
{
	...
	/**
	 * Returns the location of the bundle file or null if this descriptor
	 * describes an in-memory representation of a bundle.
	 * 
	 * @return
	 */
	...
	/**
	 * Returns the full qualified name of the main class or null if it's an
	 * runnable jar.
	 * 
	 * @return
	 */
	...
	/**
	 * Returns the name of the runnable jar file or null if the application is
	 * started using a main class.
	 * 
	 * @return
	 */
	...
	/**
	 * Returns the class path required to execute the application. It doesn't
	 * contain the JRE library since the location is platform dependent.
	 * 
	 * @return
	 */
	...
	/**
	 * Returns a set of supported operating system or an empty if all platforms
