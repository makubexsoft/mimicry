...
/**
 * A structured id used to assign unique ids based on happened-before
 * relationships. In order to create a related sub key invoke the
 * {@link #createSubId()} method.
 * 
...
public class StructuredId
{
	...
	/**
	 * Creates a new sub key where its parent is set to this id. The created sub
	 * id consists of the id of this node plus the number of current existing
	 * sub nodes. Thereby each sub id is unique while preserving the
