...
/**
 * The application bridge is created for each simulated application instance. It
 * provides reflective access to the address space of the simulated application
 * instance.
 * 
...
{
	/**
	 * Creates a new bridge to the application loaded by the given
	 * {@link ClassLoader}.
	 * 
	 * @param classLoader
	 *            The class loader used to load the application.
	 * @throws BridgeNotFoundException
	 *             If the given class loader can't find/access the bridge or the
	 *             bridge doesn't provide the required methods.
