...
/**
 * This exception is used to terminate {@link ManagedThread}s. The exception is
 * raised either by the {@link Clock} when the thread is waiting/sleeping or by
 * the {@link ThreadTerminationStratetgy} invoked each loop iteration.
 * 
